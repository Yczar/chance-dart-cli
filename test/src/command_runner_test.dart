...
import 'package:chance_dart_cli/src/command_runner.dart';
...
void main() {
  group('ChanceDartCliCommandRunner', () {
    late PubUpdater pubUpdater;
    late Logger logger;
    late ChanceDartCliCommandRunner commandRunner;
    ...
    setUp(() {
      ...
      commandRunner = ChanceDartCliCommandRunner(
        logger: logger,
    ...
    test('can be instantiated without an explicit analytics/logger instance',
        () {
      final commandRunner = ChanceDartCliCommandRunner();
